...
<head>
    ...
    <title>@yield('title', 'Casa de la Cultura Francisco de Paula Santander')</title>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav mr-auto">
                                        ...
                                        <li class="nav-item nav-social">
                                            <a target="_blank" href="https://www.facebook.com/Casa-de-la-Cultura-Santander-Medellín-213743438639983/"> <i class="fa fa-facebook-square fa-2x" aria-hidden="true"></i></a>
                                            {{--<a href="#"> <i class="fa fa-twitter-square fa-2x" aria-hidden="true"></i></a>--}}
                                            <a target="_blank" href="https://www.youtube.com/channel/UCuOXKCnhpmGt7MaxSbTUIgA"> <i class="fa fa-youtube-square fa-2x" aria-hidden="true"></i></a>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/#programas" id="donaciones-sec"><span>DESEO DONAR</span></a>
            ...
            <footer class="page-footer center-on-small-only unique-color-dark pt-0" id="contacto">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="contact-data">
                                ...
                                <ul>
                                    <li><i class="fa fa-home fa-1x"></i> Calle 110ª #76c-20 Barrio Santander - Medellín, Colombia</li>
                                    <li><i class="fa fa-envelope fa-1x"></i> info@casadelacultura.org</li>
                                    <li><i class="fa fa-mobile-phone fa-1x"></i> (+57) 301 367 55 82 </li>
                                    <li><i class="fa fa-mobile-phone fa-1x"></i> (+57) 312 234 48 80 </li>
                                    <li><i class="fa fa-phone fa-1x"></i> (+57) (4) 464 90 65 </li>
                                </ul>
                            </div>
                ...
                <div class="footer-copyright">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <p>Copyright © 2018 Casa de la Cultura FPS. Desarrollado por <a href="#">Alers Systems</a></p>
                            </div>
                        </div>
